...
public:
  ...
  virtual void setDisplayToString(const char *string, bool shouldBlink = false, const word dots = 0, const byte pos = 0,
                                  const byte font[] = FONT_DEFAULT);
  /** Set the display to the String (defaults to built in font) */
  virtual void setDisplayToString(String string, bool shouldBlink = false, const word dots = 0, const byte pos = 0,
                                  const byte font[] = FONT_DEFAULT);
