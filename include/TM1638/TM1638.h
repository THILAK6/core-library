...
class TM1638 : public TM16XX
{
  public:
    ...
    void setDisplayToBinNumber(byte number, byte dots,
		const byte numberFont[] = NUMBER_FONT);
    void setDisplayAsFiveAndThreeParts(unsigned long fivePart, unsigned long threePart, byte dots, const byte numberFont[] = NUMBER_FONT, bool leadingZerosForThreePart = false, bool leadingZerosForFivePart = false, int blinkDigitPos = -1);
    void setDisplayPart(float part, int startIndex, int length, int decimalPos = 0,int blinkDigitPos = -1, bool leadingZeros = false, const byte numberFont[] = NUMBER_FONT);
    void setDisplayNumber(int32_t value, int8_t startingPos, int8_t decimalPos, int8_t length, bool leadingZeros, const byte numberFont[], int8_t blinkDigitPos, bool blinkState);
    ...
    virtual bool isButtonPressed(byte buttonValue);
